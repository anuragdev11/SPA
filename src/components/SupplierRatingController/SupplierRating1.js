...
export default function CenteredGrid(props) {
  ...
  //let url="http://stg-users.imutils.com/wservce/users/supplierrating/token/imobile@15061981/modid/MY/input_supplier_id/17772415/sort_type/6/AK/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI4NDY5OSIsImV4cCI6MTYzOTExMDMzMywiaWF0IjoxNjM5MDIzOTMzLCJpc3MiOiJFTVBMT1lFRSJ9.WdN1PGSqjDG4T7LhHJX0geyWkmCbFKR8z3S3aYk_rwo/"
      ...
      .then(res =>res.json())
          .then(function (response) {          
            ...
            if(response.status === 200){
              ...
              //console.log(response.data.rating_influ_params_name.Response)
  ...
  const handleFilterChange = (event) => {
    if(event.target.value === 1){
      var ReviewData_Sorted = SortArray(ReviewKeys)      
      if(ReviewData_Sorted !== undefined && ReviewData_Sorted.length>0){        
      setReviewKeys([...ReviewData_Sorted])
      }
    }
